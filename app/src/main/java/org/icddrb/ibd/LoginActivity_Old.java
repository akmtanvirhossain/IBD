...
//----------------------------------------------------------------------------------------------------------------------------
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            ...
            if (Connection.haveNetworkConnection(LoginActivity_Old.this)) {
...
//            //**************************** Process **************************************
            ...
            if(Integer.valueOf(TotalTab) == 0)
            {
                ...
                {
                    Connection.MessageBox(LoginActivity_Old.this,"Internet connection is not available for building initial database.");
                    //finish();
                    //System.exit(0);
                    return;
                }
...
//                            C.DownloadJSON(SQLStrRSV, TableNameRSV, VariableListRSV, "ChildID, SlNo");
                        ...
                        */
                        ...
                        if(networkAvailable==true)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    Connection.MessageBox(LoginActivity_Old.this, "আপনার ট্যাব এর তারিখ সঠিক নয় ["+ Global.DateNowDMY() +"]।");
                    ...
                    {
                        Connection.MessageBox(LoginActivity_Old.this, ex.getMessage());
                        return;
                    }
                }
            });
